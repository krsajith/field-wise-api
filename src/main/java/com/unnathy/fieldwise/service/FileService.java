...
import com.unnathy.fieldwise.entity.File;
import com.unnathy.fieldwise.entity.User;
import com.unnathy.fieldwise.repo.FileRepository;
...
public class FileService implements BasicEntityService<FileDTO, Long> {
