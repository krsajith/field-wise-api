...
public class ShopTypeController implements BaseController<ShopTypeDTO, ShopTypeDTO, Long> {

    private final ShopTypeService service;

    @Override
    public BasicEntityService<ShopTypeDTO, ShopTypeDTO, Long> getService() {
        return service;
    }
}
