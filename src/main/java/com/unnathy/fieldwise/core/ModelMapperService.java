...
public class ModelMapperService implements InitializingBean {
    ...
    public  Object merge(Object first, Object second,String...fieldsToSkip) {
        ...
        List<String> fieldToSkipList = Arrays.stream(fieldsToSkip).toList();
        for (var pd : fields) {
            if (fieldToSkipList.contains(pd.getName())) continue;
            try {
